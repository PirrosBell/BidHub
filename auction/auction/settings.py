...
SECRET_KEY = 'django-insecure-%859ck9x0l6-cf&6ctr2p*%5s2jlhzw(p)gppd*5k^r80%v@sm'
...
INSTALLED_APPS = [
    ...
    'faker', # For fake dataset creation
    
]

# CRON_CLASSES = [
#     'bids.cron.CheckExpiredItemsJob',
#     'bids.cron.RefreshRecommendationsJob',
# ]
